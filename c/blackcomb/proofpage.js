...
//    divtext         = $("divtext");
    ...
    addEvent($('divcharpicker'), "mouseout",  ePickerOut);
...
//    tatext.style.lineHeight     = GetLineHeight();
    ...
    boxwidth                        = doc.body.offsetWidth
                                        - (Layout() == "vertical" ? 4 : 0);
    console.debug("box " + boxheight.toString() + " " + boxwidth.toString());
    ...
    if(Layout() == 'horizontal') {
        ...
        console.debug("lh: " + leftheight.toString() + "  rh: " + rightheight.toString());
        ...
        console.debug("lw: " + leftwidth.toString() + "  rw: " + rightwidth.toString());
