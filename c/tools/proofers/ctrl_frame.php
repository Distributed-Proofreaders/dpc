...
?>
  <style type="text/css">
    ...
    body { font-family: verdana, arial, helvetica, sans-serif; font-size: 12px;
        color:#000000; background-color:#CDC0B0; padding:0; margin: 2px 0 -2px;
        text-align:center; 
    }
    .dropsmall { font-size: 75%; background-color:#FFF8DC; }
    .dropnormal { background-color:#FFF8DC; }
    #markBoxChar { background-color:#FFF8DC; font-size: 1.5em; padding-left:
        .5em; width: 2em; } 
...
<body>
<a href="#" accesskey="=" onfocus="top.focusText()" ></a>
<form name="markform" id="markform" onsubmit="return(false);" action="ctrl_frame.php" >
...
?>
    ...
    <td valign="top" align="center" >
      <input accesskey="[" TYPE="text" VALUE="" name="markBox"
        class="dropnormal" size="9" onclick="this.select();" > 
      <input accesskey="]" TYPE="text" VALUE="" name="markBoxEnd" class="dropnormal"
        size="9" onclick="this.select()" >
<?
...
<?
echo  "<span class='red bold'>" . _("HELP") . "---&gt;</span>";
?>

      <a href="../../faq/prooffacehelp.php" accesskey="1" target="helpNewWin" >
      <img src="gfx/tags/help.png" width="18" height="18" border="0" align="top"
        alt="<? echo _("Help"); ?>" title="<? echo _("Help"); ?>" >
      </a>
    </td>
  </tr>
  <tr>
...
onClick="window.open('greek2ascii.html','gkasciiWin','width=640,height=210,directories=0,location=0,menubar=0,resizable,scrollbars,status=0,toolbar=0'); return false;">
</div>
<div class='divguides'>
<?php
