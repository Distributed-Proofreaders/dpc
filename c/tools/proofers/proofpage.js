...
function applylayout() {
    ...
    divpreview.style.fontFamily = GetFontFace();
    tatext.style.fontFamily     = GetFontFace();
    divpreview.style.fontSize   = GetFontSize();
    ...
    boxheight                       = doc.body.clientHeight - divstatusbar.clientHeight
                                                            - divcontrols.clientHeight;
    ...
    if(Layout() == 'horizontal') {
        ...
        // the right div (really bottom) extends all the way across,
        // and from the bottom of the splitter to the top of the controls div.
        divright.style.top          = px(barpos + 4);
        divright.style.left         = "0";
        divright.style.height       = px(boxheight - 4 - barpos);
        ...
        divright.style.left         = px(barpos + 4);
        divright.style.height       = px(boxheight);
        divright.style.width        = px(boxwidth - barpos - 4);
