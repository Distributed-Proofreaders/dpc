...
$editor             = lower(Arg("editor", $User->Editor()));
...
echo "
<script language='JavaScript' type='text/javascript' src='proofers/dp_scroll.js?1.14'></script>
<script language='JavaScript' type='text/javascript' src='proofers/dp_proof.js?1.49'></script>
