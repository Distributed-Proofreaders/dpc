...
each row of data:
key is weekval, val is 6-value array
data['Week'] = 'Week', 'P1', ...
data['201344'] = array(p1val, p2val, p3val, ...)
w, r, c goes to data[w][$ridx[r]];
*/

$ridx = array("P1" => 1, "P2" => 2, "P3" => 3, "F1" => 4, "F2" => 5);

// first day of week 14 weeks agao (for labels)
$date1 = $dpdb->SqlOneValue("
    SELECT DATE_ADD(DATE_SUB(CURRENT_DATE(), INTERVAL WEEKDAY(CURRENT_DATE()) DAY), INTERVAL 14 WEEK);");
//$weekvals = array();
...
$w1 = $dpdb->SqlOneValue("
               SELECT YEARWEEK(DATE_SUB(CURRENT_DATE(), INTERVAL 13 WEEK))");
