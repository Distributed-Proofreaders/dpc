...
if(IsArg("opt_return_quit_x")) {
	$seltodo = "opt_return_quit";
}
else
if(IsArg("opt_submit_quit_x")) {
	$seltodo = "opt_submit_quit";
}
else
	if(IsArg("opt_draft_continue_x")) {
		$seltodo = "opt_draft_continue";
	}
	else
if(IsArg("opt_draft_quit_x")) {
	$seltodo = "opt_draft_quit";
}
else
if(IsArg("opt_mark_bad_x")) {
...
if(! $page->UserIsOwner() && ! $User->IsSiteManager() && ! $page->UserIsPM()) {
