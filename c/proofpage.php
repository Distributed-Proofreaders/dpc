...
<fieldset id='fsCmd'>
  <legend>Command display</legend>
    <label><input type='radio' name='rdoEditor' id='rdopennask' value='pennask'> Icons </label>
    <label><input type='radio' name='rdoEditor' id='rdoahmic' value='ahmic'> Menu </label>
</fieldset>
<fieldset id='fsWC'>
  <legend>WordCheck</legend>
    <label><input type='checkbox' name='chkIsWC' id='chkIsWC' {$wcchecked}> Enabled </label>
</fieldset>
...
<div id='divright'>
  ...
  <div id='divfratext'>
    <div id='divtext'>
      <pre id='prepreview' class='lh11'><span id='spanpreview'>{$prooftext}</span><br></pre>
...
-->
	...
	echo "
		...
		<div id='divicons' class='$iconsclass'>
	...
	echo "
		<div id='divmenu' class='$menuclass'>
...
class DpCookie
{
    ...
    private $_editor;   // pennask, ahmic, whistler, blackcomb, std, enhanced
    private $_lineheight;
    private $_issync;

    function __construct($zoom = "100", $fontface = "Courier", $fontsize = "14pt", $editor = "pennask") {
    }
