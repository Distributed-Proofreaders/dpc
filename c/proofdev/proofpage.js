...
//function divtext_match_divpreview() {
...
function eKeyUp(e) {
    ...
    // need to reset divpreview.innerHTML and derive divtext dimensions
...
function ePunctuation() {
    var re = /[;:\.,!?]/g;
    divpreview.innerHTML = divpreview.innerHTML.replace(re, "<span class='punc'>$&</span>");
}
function eNoPunctuation() {
    var re = /<span class='punc'>(.)<\/span>/g;
    divpreview.innerHTML = divpreview.innerHTML.replace(re, "\1");
}
...
function maybe_scroll() {
    ...
    divfratext.scrollTop = divpreview.scrollTop;
