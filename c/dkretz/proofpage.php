...
echo "
    ...
    if($editor == "whistler") {
        ...
        <input type='image' id='opt_draft_quit' name='opt_draft_quit' title='$quit_prompt' alt='$quit_prompt'
            src='gfx/quit.png'>
  ...
  <div id='divfratext'>
    <div id='divtext'>
      ...
      <textarea name='tatext' id='tatext' class='dpeditor' wrap='off'>{$prooftext}</textarea>
    </div>
  </div> <!-- divfratext -->
<!--
  <div id='divtweet'>
