...
function eCtlInit() {
    ...
    $('rdo' + getEditorStyle()).checked = 'checked';
    $('rdo' + getLineHeight()).checked = 'checked';
    ...
    // rdoeditor.value = getEditorStyle();
    // rdolineheight.value = getLineHeight();
    // rdoeditor[getEditorStyle()].checked = "checked";
    // rdolineheight[getLineHeight()].checked = "checked";
}
...
function eGearClick(e) {
    ...
    switch(e.target.name) {
        case "rdoEditor":
            ...
            $("divicons").className = (target.value == "ahmic" ? "hide" : "block");
            $("divmenu").className = (target.value == "ahmic" ? "block" : "hide");
            break;
        case "rdoLineHeight":
...
function applyLineHeight(lhclass) {
    ...
    tatext.style.lineHeight     = lhclass;
}
...
function setIsWC(val) {
    setnamevalue("iswc", val ? "1" : "0");
}
