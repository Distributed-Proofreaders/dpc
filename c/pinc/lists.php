...
$wclangs2 = array(
    ...
    "fi" => "Finnish",
    "fr" => "French",
    "German_de_CH" => "German Switzerland",
    "German_de_AT" => "German Austria",
    "German_de_DE" => "German Germany",
    "grc" => "Greek ancient",
    "el" => "Greek modern",
    "eo" => "Esperanto",
    "he" => "Hebrew",
    ...
    "es_PY" => "Spanish Puerto Rico",
    "es_SV" => "Spanish San Salvador",
    "es_US" => "Spanish US",
